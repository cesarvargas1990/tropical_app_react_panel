...
describe("SizeModal", () => {
  ...
  it("updates toppings and delivery through global controls", () => {
    ...
    const { onUpdateSize: updateSpy } = renderModalWithState(initialState, {
      onUpdateSize,
    });
    ...
    const keypad = screen
      .getByText(/Ingrese valor topping/i)
      .closest(".keypad-modal");
